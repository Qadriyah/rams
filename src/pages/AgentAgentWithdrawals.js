...
class AgentAgentWithdrawals extends Component {
  render() {
    return (
      <div>
        <div
              ...
              <div className="row">
                <div className="col-xs-12">
                  <div className="white-box">
                    <h3 className="box-title">Agent-Agent Withdrawals</h3>
                    <a
...
export default AgentAgentWithdrawals;
